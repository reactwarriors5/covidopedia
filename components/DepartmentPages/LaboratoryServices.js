    ...
    return (
        <div className="grid grid-cols-3 gap-2 mt-10 ">
            <div className="ml-32 flex w-90 bg-purple-200 h-16 rounded-sm shadow-md hover:bg-indigo-300">
                ...
                <h1 className="text-md mt-4 ">Our Company Details</h1>
            </div>
            <div className="col-span-2 grid grid-cols-2 ml-4">
                <div className="grid  mr-9">
                    <div className="mb-6">
                        <h1 className="font-semibold font-bold text-2xl text-justify">Medical laboratory and specialists services</h1>
                    </div>
                    <div className="mb-6">
