    ...
    return (
        <div className="flex justify-between items-start mb-8 shadow-sm p-5 bg-white">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 lg:w-1/2">
                ...
                <div className="font-semibold text-gray-700">
                    ...
                    <div className="flex  text-gray-500 ">
                        ...
                        <p className="text-xs ">{openTime}</p>
                    </div>
            ...
            <div className="-space-y-2 grid grid-cols-1 gap-4 mr-14 mt-5 text-md">
               ...
               <a href=""
                className="bg-indigo-700 text-white active:bg-indigo-700 font-bold uppercase text-base px-8 py-3 rounded shadow-md hover:shadow-lg outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150" 
               >
               <button 
               type="button"
                >
...
export default PharmaCardDetails;
