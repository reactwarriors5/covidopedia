...
const Content = () => {
    return (
        <section class="text-gray-600 body-font ">
            <div class="container px-5 py-24 ml-8">
                <div class="flex flex-wrap w-full mb-10 flex-col items-center text-center">
                    <h1 class="sm:text-3xl text-2xl font-medium title-font  text-gray-900">Wide range of facilities and medical services</h1>
                </div>
                <div class="flex flex-wrap mr-25">
