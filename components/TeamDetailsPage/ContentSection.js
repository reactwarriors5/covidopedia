            ...
            <div className="grid max-w-screen-lg gap-4 lg:grid-cols-2 sm:mx-auto">
                <div className="flex flex-col justify-center">
                    ...
                    <div className="flex">
                        ...
                        <div className="w-3/4">
                            <h6 className="mb-2 font-semibold leading-5 rounded-lg text-center p-5 hover:bg-indigo-300 shadow-md">
                            Pulmonology
                            </h6>
                    ...
                    <div className="flex">
                        ...
                        <div className="w-3/4">
                            <h6 className="mb-2 font-semibold leading-5 rounded-lg text-center  p-5 shadow-md hover:bg-indigo-300 ">
                            Gastrologic
                            </h6>
                        </div>
                    </div>
