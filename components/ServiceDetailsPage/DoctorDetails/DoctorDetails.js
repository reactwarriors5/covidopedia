...
const DoctorDetails = () => {
    return (
        <div class="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-2 lg:py-20">
            <div class="flex flex-col overflow-hidden bg-white border rounded shadow-sm lg:flex-row sm:mx-auto">
                ...
                <div class="flex flex-col justify-center p-8 bg-white lg:p-16 lg:pl-10 lg:w-1/2">
                    ...
                    <p class="mb-5 text-gray-800">
                        Email       info@creativesplanet.com
                    </p>
                    <p class="mb-5 text-gray-800">
                        Website     www.creativesplanet.com
                    </p>
                    <p class="mb-5 text-gray-800">
                        Fax     123456789
                    </p>
